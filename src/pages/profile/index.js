...
const [address, setAddress] = React.useState(null)
  ...
  React.useEffect(() => {
    ...
    axios.get(`${process.env.NEXT_PUBLIC_API_URL}/addresses/users/${userId}`,config)
                    ...
                    <form>
                      <div class="mb-3">
                        <div className="row">
                          ...
                          <div className="col-9">
                            <input type="text" class={`form-control ${style.in}`} id="exampleInputName" placeholder={profile?.name} onChange={(event) => setName(event.target.value)} />
                          </div>
                        </div>
                      </div>
                      <div class="mb-3">
                        <div className="row">
                          ...
                          <div className="col-9">
                            <input type="email" class={`form-control ${style.in}`} id="exampleInputEmail1" aria-describedby="emailHelp" placeholder={profile?.email} onChange={(event) => setEmail(event.target.value)} />
                          </div>
                        </div>
                      </div>
                      <div class="mb-3">
                  ...
                  <div className="mt-5">
                    ...
                    <label className="btn btn-outline-danger mb-3" for="danger-outlined1">
                      <div className="container m-2 text-lg-start text-dark">
                        <h5>{address?.[0]?.recipient_name}</h5>
                        <h6>{address?.[0]?.address_alias}</h6>
                        <p>{address?.[0]?.street}, {address?.[0]?.city}, {address?.[0]?.postal_code}, <br /> hp: {address?.[0]?.recipient_phone_number}</p>
